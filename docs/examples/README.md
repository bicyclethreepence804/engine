...
| Item | Description |
| ---- | ----------- |
| [`result-layout-demo.html`](result-layout-demo.html) | Open in a browser (developer setup, npm, CLI, doc links), `analyze` / `analyzeFromTrades` / `analyzeFromWindows` samples, verdicts, and contract tables |
